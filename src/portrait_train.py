...
from configs.portrait_config import cfg
...
parser.add_argument('--ext_dir', default=r"",
                    help="path to your dataset")
parser.add_argument('--fusion_dir', default=r"D:\PythonCode\BiSeNet\data\data_aug_3400",
                    help="path to your dataset")
...
if __name__ == '__main__':
    ...
    path_model_34 = os.path.join(BASE_DIR, "..", "data", "pretrained_model", "resnet34-333f7ec4.pth")  # bisenet
    path_model_50 = os.path.join(BASE_DIR, "..", "data", "pretrained_model", "resnet50-19c8e357.pth")  # bisenet
    ...
    # ------------------------------------ step 2/5 : 定义网络------------------------------------
    cls = 1  # hardcode
    model = BiSeNet(cls, "xception39")
    # model = BiSeNet(cls, "resnet18", path_model_18)
    # model = BiSeNet(cls, "resnet34", path_model_34)
    # model = BiSeNet(cls, "resnet50", path_model_50)
