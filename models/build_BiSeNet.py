# -*- coding: utf-8 -*-
"""
@Time : 2021/9/22 15:47 
@Author : Zhi QIN 
@File : build_BiSeNet.py 
@Software: PyCharm
@Brief : 
"""
...
class BiSeNet(torch.nn.Module):
    def __init__(self, num_classes, context_path, path_model=None):
        ...
        if context_path == 'resnet101':
            ...
            # build feature fusion module
            self.feature_fusion_module = FeatureFusionModule(num_classes, 1024)
        elif context_path == 'xception39':
            # build attention refinement module  for xception 39
            self.attention_refinement_module1 = AttentionRefinementModule(128, 128)
            self.attention_refinement_module2 = AttentionRefinementModule(256, 256)
            # supervision block
